...
public class InputUtil
{
    ...
    public static bool IsPointerOverElement(string layerName)
    {
        return IsPointerOverUIElement(GetEventSystemRaycastResults(), layerName);
    }
    ///Returns 'true' if we touched or hovering on Unity UI element.
    static bool IsPointerOverUIElement(List<RaycastResult> eventSystemRaysastResults, string layerName)
    {
